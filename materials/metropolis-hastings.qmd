...
1. [Problem Statement](#why-integrals)
2. [Markov Chains](#markov-chains)
4. [Metropolis-Hastings explained](#metropolis-hastings)
5. [What are the limitations?](#metropolis-hastings-limitations)

Recap from last week:

**[What is MCMC trying to solve](week2.md#MCMC)**: MCMC
